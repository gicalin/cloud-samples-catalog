...
* Test the UI by choosing *Run -> Run as -> SAP Fiori Launchpad Sandbox* from the context menu of the ui-productCatalog folder. Click on the app tile to launch the application.
